...
def savel_all_udpate_interval(all_update_interval):
    df_all_upint = pd.DataFrame(all_update_interval, columns=['Column1'])
    csv_filename = 'scrap_results/csv/all_update_interval_{}.csv'.format(serial)
    df_all_upint.to_csv(csv_filename, index=False)
...
if __name__ == "__main__":
    ...
    # serial_id_list = [214755386, -1408231797, -1408235040, 13042006, -1408231792]
    serial_id_list = [1433801924]
    ...
    for serial in serial_id_list:
        ...
        savel_all_udpate_interval(all_update_interval)
